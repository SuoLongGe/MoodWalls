...
| **M04** | AI 情感回信  | `SupportDialog.ets`          | P0  | 前端完成，待接口      |
| **M05** | 校园情绪地图   | `MapTab.ets`                 | P1  | 静态 Mock，待数据驱动 |
| **M06** | 个人情绪档案   | `ProfileTab.ets`             | P1  | 静态 Mock，待接口   |
| **M07** | 通知系统     | `MoodWallHeader.ets`         | P2  | 入口已有，待开发      |
...
| **交付标准** | 发帖/接住心声有 AI 回信、地图显示区域统计、通知可读写                                             |
