...
CREATE TABLE IF NOT EXISTS users (
  ...
  avatar_url    VARCHAR(512) DEFAULT NULL COMMENT '自定义头像相对路径，如 /uploads/avatars/2026/06/11/xxx.jpg',
...
CREATE TABLE IF NOT EXISTS posts (
  ...
  image_url   VARCHAR(512) DEFAULT NULL COMMENT '配图相对路径，如 /uploads/posts/2026/06/05/xxx.jpg',
