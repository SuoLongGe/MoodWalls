...
public class CommentDto {
    ...
    private List<CommentReplyDto> replies = new ArrayList<>();
    ...
    public List<CommentReplyDto> getReplies() { return replies; }
    public void setReplies(List<CommentReplyDto> replies) { this.replies = replies; }
}
